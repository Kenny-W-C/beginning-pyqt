...
class Notepad(QMainWindow):
    ...
    def notepadMenu(self):
        ...
        highlight_act = QAction(QIcon('images/highlight.png'), 'Highlight',
                                self)
    ...
    def chooseFont(self):
        ...
        if ok:
            self.text_field.setCurrentFont(
                font)  # Use setFont() to set to one type of font
    ...
    def aboutDialog(self):
        ...
        QMessageBox.about(self, "About Notepad",
                          "Beginner's Practical Guide to PyQt\n\nProject 5.1 - Notepad GUI")
