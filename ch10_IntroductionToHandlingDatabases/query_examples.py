...
class QueryExamples:
    ...
    def exampleQueries(self):
        ...
        query = QSqlQuery()
        query.exec_(
            "SELECT first_name, last_name FROM accounts WHERE employee_id > "
            "2000")
        ...
        # If an error occurs, exec() returns false. The error is then
        # available
        ...
        # query = QSqlQuery()
        query.exec_(
            "UPDATE accounts SET department = 'R&D' WHERE employee_id = 2134")
