...
class KeypadGUI(QtWidgets.QWidget):
    ...
    def initializeUI(self):
        ...
        self.ui.line_edit1.setMaxLength(
            1)  # Set the max number of characters allowed
        self.ui.line_edit1.setValidator(
            QIntValidator(0, 9))  # User can only enter ints from 0-9
        self.ui.line_edit1.setFocusPolicy(
            QtCore.Qt.NoFocus)  # Widget does not except focus
    ...
    def numberClicked(self, text_value):
        ...
        if self.ui.line_edit1.text() == "":
            ...
            self.ui.line_edit3.repaint()
                ...
                self.ui.line_edit2.text() != "") \
                and (self.ui.line_edit3.text() != "") and (
    ...
    def checkPasscode(self):
        ...
        entered_passcode = self.ui.line_edit1.text() + \
                           ...
                           self.ui.line_edit4.text()
        if len(entered_passcode) == 4 and int(
                entered_passcode) == self.passcode:
